...
export default function MyWork() {
  ...
  const filteredWork = useMemo(() => {
    return myWork.filter(item => {
      ...
      if (filterStatus === 'active') {
        ...
        // Overdue = past due date and not done/published
  ...
  }, [myWork, filterType, filterStatus]);
          ...
          <Card hover={false}>
            <div className="p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-2xl font-bold text-white">{stats.tasks.overdue}</span>
              </div>
          ...
          <Card hover={false}>
            <div className="p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-2xl font-bold text-white">{stats.dueToday}</span>
              </div>
          ...
          <Card hover={false}>
            <div className="p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-2xl font-bold text-white">{stats.dueThisWeek}</span>
              </div>
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-gray-400">
              {filterStatus === 'active' 
                ...
                : 'Your work items will appear here'}
            </p>
          </div>
        ) : (
            ...
            {filteredWork.map((item, index) => {
              ...
              return (
                <div 
                  ...
                  className="p-5 hover:bg-[#1a1333]/50 transition-all duration-300 animate-fadeIn"
                  style={{ animationDelay: `${index * 50}ms` }}
                >
                  <div className="flex items-start gap-4">
                    {/* Type Icon */}
                    <div className="w-10 h-10 bg-[#1a1333] rounded-lg flex items-center justify-center flex-shrink-0">
                      {getTypeIcon(item)}
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="text-xs text-gray-500">
                          Progress: <span className="text-white font-medium">{item.progress}%</span>
                        </div>
                        {item.projectId && (
